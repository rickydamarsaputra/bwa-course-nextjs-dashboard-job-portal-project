      ...
      <div className="grid grid-cols-3 w-full gap-5">
        ...
        <div>
          ...
          <div className="my-10">
            ...
            <div className="space-x-5">
              {['HTML', 'Javascripts'].map((item: string, i: number) => (
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          {[0,1,2].map((item: number) => (
            <div key={item}>
              ...
              <div className="text-gray-500">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Velit illo, ratione vero expedita at fugiat voluptas quod veniam perferendis unde.
              </div>
            </div>
          ))}
        </div>
