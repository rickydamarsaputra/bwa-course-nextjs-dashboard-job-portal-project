    ...
    <div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-7">
            <FieldInput title="Company Logo" subTitle="This image will be shown publicly as company">
                ...
                <FormField
                  ...
                  render={({field}) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Twitter" className="w-[450px]" {...field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({field}) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="https://twitter.com" className="w-[450px]" {...field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <FieldInput title="About Company" subTitle="Brief description for your company. URL are hyperlinked">
